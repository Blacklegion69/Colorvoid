    ...
    <Card className="w-full p-2 rounded shadow-md">
      {isOpen ? (
        <div className="w-full flex justify-center items-center flex-col gap-y-3">
          <Card className="w-full flex justify-between items-center flex-col">
              ...
              <Card className="w-full border-none grid p-2 grid-cols-3 gap-2 justify-center items-center ">
                {colors.map((each) => {
                  return (
                    ...
                    >
                      <Card
                        style={{ borderLeft: `9px solid ${each.color}` }}
          ...
          <Card className="w-full border-none grid grid-cols-2 gap-2">
            <Card>
