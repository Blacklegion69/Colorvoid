...
const Counterslice = () => {
  ...
  return (
    <Card className="w-full p-2 my-2 flex flex-col justify-center shadow-lg items-center relative">
      <Card className="w-full p-2 font-bold text-right flex justify-between items-center">
        {!expend ? (
          <RadioGroup
          ...
          >
            <Card className="border-2 border-transparent  flex justify-center items-center gap-1 border-l-slate-900 border-r-slate-900 dark:border-l-slate-100 dark:border-r-slate-100 px-1">
              <Checkbox
                checked={repeating}
      ...
      {expend ? (
        <>
          <Card className="w-full my-2 font-bold ">Logic :</Card>
          <Card className="w-full flex flex-col">
            {data.map((d, id) => {
              return (
                <Card key={id} className="w-full my-1 flex items-center">
                  <Checkbox
                    checked={d.status}
                  ...
                  >
                    ...
                    <Card className="mx-2">{d.label}</Card>
                  </Label>
                </Card>
              );
            })}
          ...
          {repeating ? (
            <>
              ...
              <Card className="w-full font-bold ">Repeating unit:</Card>
              <RadioGroup
                className="w-full text-2xl ml-4 my-2 flex flex-col"
                defaultValue={repeatingUnit}
                value={repeatingUnit}
                onValueChange={(e: any) =>
                  dispatch(setRepeatingunit({ repeatingUnit: e }))
              ...
              >
                <Card className="flex items-center space-x-2">
                  ...
                  <Label
                    ...
                    htmlFor="r1"
                  >
                    <MonitorSmartphone className="mx-2" />
                    Pixel
                  </Label>
                </Card>
                <Card className="flex items-center space-x-2">
                  ...
                  <Label
                    ...
                    htmlFor="r2"
                  >
                    <BadgePercent className="mx-2" />
                    Percent
                  </Label>
                </Card>
              </RadioGroup>
              <Card className="w-full my-2 grid grid-cols-5 gap-2 justify-center items-center relative">
                <Button
                  onClick={() =>
                ...
                <Card className="text-center text-2xl">
                  {repeatingLength}
                  {repeatingUnit === "px" ? "px" : "%"}
                </Card>
                <Button
